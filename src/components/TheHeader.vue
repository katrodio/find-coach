					...
					<ul class="menu__list user-nav">
						...
						>
							...
							>
								...
								<a :href="href" @click="navigate" class="user-nav__logout"
									>Войти</a
								>
							</li>
						</router-link>
						...
						>
							...
							>
								...
								>
									<path
										d="M17 7L15.6 8.4L18.2 11H8V13H18.2L15.6 15.6L17 17L22 12L17 7Z"
									/>
									<path
										d="M6 5L14 5L14 3L6 3C4.9 3 4 3.9 4 5L4 19C4 20.1 4.9 21 6 21L14 21L14 19L6 19L6 5Z"
									/>
								</svg>
								<a :href="href" @click="navigate" class="user-nav__logout"
									>Выйти</a
...
export default {
	...
	watch: {
		...
		'$store.state.auth.currentUserId'() {
			document.querySelector('.hamburger-input').checked = false;
		},
	},
};
...
@media screen and (max-width: 901px) {
	...
	.hamburger-input:checked ~ .menu__list {
		display: block;
	}
}
</style>