	...
	<base-container>
		<base-card>
			<section class="registration-form">
				...
				>
					...
					<input
						...
						v-model="name"
					/>
					<p class="registration-form__error" v-if="'name' in errors">
						{{ errors.name }}
					</p>
					...
					<input
						...
						v-model="lastName"
					/>
					<p class="registration-form__error" v-if="'lastName' in errors">
						{{ errors.lastName }}
					</p>
					...
					<p class="registration-form__error" v-if="'gender' in errors">
						{{ errors.gender }}
					</p>
					...
					<input
						...
						v-model="price"
					/>
					<p class="registration-form__error" v-if="'price' in errors">
						{{ errors.price }}
					</p>
					...
					<input
						...
						v-model="description"
					/>
					<p class="registration-form__error" v-if="'description' in errors">
						{{ errors.description }}
					</p>
					...
					<p
						...
						v-if="'specializations' in errors"
					>
			...
			<transition name="modal">
				<base-modal v-if="successfulReg" @closeModal="redirectTo('/')">
					<p style="font-size: 18px">
						Тренер зарегистрирован!<br />Нажмите "Обновить" на главной странице
						для отображения вас в списке
					</p>
				</base-modal>
			</transition>
		</base-card>
...
export default {
	...
	methods: {
		...
		validateForm() {
			...
			if (!this.gender) {
				this.errors.gender = 'Вам необходимо выбрать пол';
			}
